...
#define INITIAL_FREQ 250
//Initialize the parameters for Ethernet
byte mac[] = { 0xDE, 0xAD, 0xBE, 0xEF, 0x01, 0x06 };
byte ip[] = { 192, 168, 1, 6}; // Assigned by DHCP. This may change. This IP address is for a single Source Address
...
void setup()
{
  ...
  analogWriteFrequency(NFET1Pin, INITIAL_FREQ); // Mid range of 12-bit resolution
  analogWrite(NFET1Pin, 127); // Mid range of 12-bit resolution
